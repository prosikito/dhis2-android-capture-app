...
public class AgeHolder extends FormViewHolder {
    ...
    AgeHolder(FormAgeCustomBinding formAgeCustomBinding, FlowableProcessor<RowAction> processor) {
        super(formAgeCustomBinding);
        this.formAgeCustomBinding = formAgeCustomBinding;
        formAgeCustomBinding.customAgeview.setAgeChangedListener(ageDate -> {
