...
public class ImageHolder extends FormViewHolder {
    ...
    public void update(ImageViewModel viewModel) {
        ...
        Bindings.setObjectStyle(formImageBinding.icon, itemView, viewModel.objectStyle());
        Bindings.setObjectStyle(formImageBinding.label, itemView, viewModel.objectStyle());
